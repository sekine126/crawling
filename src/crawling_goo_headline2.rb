...
# スクレイピング先のURL
# goo_headline_20xxxxxx.txtの内容は修正する必要がある
# ・先頭に http://news.goo.ne.jp
my_crawl.set_urls("./data/goo_headline_"+params["d"]+".txt")
...
# 取得するURLのXpathを設定
my_crawl.url_xpath = '//a[@id="topics_1_more"]'

# セーブするファイルの名前
my_crawl.filename = "goo_headline2"
